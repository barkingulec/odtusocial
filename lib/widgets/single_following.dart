...
class SingleFollowing extends StatefulWidget {
  final data;
  const SingleFollowing({ Key? key, required this.data}) : super(key: key);

  @override
  State<SingleFollowing> createState() => _SingleFollowingState();

}

class _SingleFollowingState extends State<SingleFollowing>{
