...
class SingleComment extends StatefulWidget {
  final commentData;
  const SingleComment({super.key, this.commentData});
...
getData() async {
    ...
    try {
      ...
      //datediff = widget.commentData.data()['date'].toDate().difference(DateTime.now());
  ...
  deleteComment() async {
    ...
    try {
      res = await FireStoreMethods().deleteCommentFromEvent(
                widget.commentData.data()['communityId'],
                widget.commentData.data()['eventId'],
                ...
                child: GestureDetector(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //const SizedBox(height: 10),
                      // SvgPicture.asset("assets/delete.svg", color: pink.withOpacity(.6), width: 24, height: 24,),
                      //Text("Reply"),
                  ],),
                ),
              ),
