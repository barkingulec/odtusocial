...
class FeatureItem extends StatefulWidget {
  const FeatureItem({ Key? key, required this.data, this.width = 280, this.height = 290}) : super(key: key);
  final data;
  final double width;
  final double height;

  @override
  State<FeatureItem> createState() => _FeatureItem();
}
